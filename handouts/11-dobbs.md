...
And that means: “When the Court decimates a right women have held for 50 years, the Court is not being ‘scrupulously neutral.’ It is instead taking sides: against women who wish to exercise the right, and for States (like Mississippi) that want to bar them from doing so.” *Id.* And so they succeeded.
